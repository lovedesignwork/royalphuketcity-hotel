...
const SLUG = "premier-superior-sea-view";
const room = ROOM_DETAILS[SLUG];

export const metadata: Metadata = {
  title: room.name,
  description: `${room.name} room at Royal Phuket City Hotel. ${room.size} with stunning partial sea views. Perfect for up to ${room.maxGuests} guests.`,
  alternates: {
...
export default function PremierSuperiorSeaViewPage() {
