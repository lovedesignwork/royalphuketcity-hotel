...
export const metadata: Metadata = {
  title: "Artist Story",
  description:
    "Explore the art collection at Royal Phuket City Hotel. Discover local Thai artists and their works that adorn our spaces, celebrating Phuket's rich cultural heritage.",
};
