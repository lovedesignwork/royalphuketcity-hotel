...
const SLUG = "premier-deluxe";
const room = ROOM_DETAILS[SLUG];

export const metadata: Metadata = {
  title: room.name,
  description: `${room.name} room at Royal Phuket City Hotel. Spacious ${room.size} with enhanced amenities and ${room.views.join(", ")}. Up to ${room.maxGuests} guests.`,
  alternates: {
...
export default function PremierDeluxePage() {
