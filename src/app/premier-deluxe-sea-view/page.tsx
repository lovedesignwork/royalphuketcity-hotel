...
const SLUG = "premier-deluxe-sea-view";
const room = ROOM_DETAILS[SLUG];

export const metadata: Metadata = {
  title: room.name,
  description: `${room.name} room at Royal Phuket City Hotel. ${room.size} with partial sea views and premium furnishings. Up to ${room.maxGuests} guests.`,
  alternates: {
...
export default function PremierDeluxeSeaViewPage() {
