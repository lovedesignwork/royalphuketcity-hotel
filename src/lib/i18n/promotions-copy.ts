...
const promotionsTh: Record<PromoSlug, PromoCopy> = {
  ...
  "yan-long-dining": {
    title: "โปรร้านอาหารหยันหลง",
    subtitle: "อาหารจีนต้นตำรับในเมืองเก่าภูเก็ต",
    tagline: "ร้านอาหาร",
    shortDescription:
      "แขกโรงแรมลด 10% เมนูอาลาคาร์ตที่หยันหลง เป็ดปักกิ่ง ติ่มซำ และอาหารกวางตุ้งบนชั้น 1",
    highlights: [
      "ลด 10% สำหรับแขกโรงแรม",
      "เป็ดปักกิ่งซิกเนเจอร์",
      "ติ่มซำทุกวัน 11:00 – 14:00",
      "ห้องส่วนตัวจองได้",
      "เปิดทุกวัน 11:00 – 22:00",
    ],
    terms: [
      "แสดงคีย์การ์ดหรือหลักฐานการจอง",
      "ใช้ร่วมกับโปรร้านอาหารอื่นไม่ได้",
      "ขึ้นอยู่กับที่ว่าง",
    ],
    price: "แขกโรงแรมลด 10%",
    originalPrice: "",
  },
  "spa-guest-recovery": {
    title: "โปร Royal Wellness Spa",
    subtitle: "แขกโรงแรมลด 10% ทุกทรีตเมนต์",
    tagline: "สปา",
    shortDescription:
      "ผ่อนคลายที่ชั้น 3 แขกโรงแรมลด 10% ทุกทรีตเมนต์ รวม Recovery Starter และคอร์สคู่",
    highlights: [
      "ลด 10% สำหรับแขกโรงแรม",
      "เปิดทุกวัน 10:00 – 23:00",
      "จองคิวสุดท้าย 22:00",
      "ชั้น 3 อาคารเดียวกับสระว่ายน้ำ",
      "ชำระที่สปา",
    ],
    terms: [
      "แสดงคีย์การ์ดที่เคาน์เตอร์สปา",
      "จองคิวสุดท้าย 22:00",
      "ขึ้นอยู่กับคิวนักบำบัด",
    ],
    price: "แขกโรงแรมลด 10%",
    originalPrice: "",
  },
