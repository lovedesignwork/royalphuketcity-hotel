export const SPA_SITE_URL = "https://www.royalwellnessspaphuket.com";
export const SPA_PHONE = "090-596-9666";
export const SPA_HOURS = "10:00 AM - 11:00 PM";
...
export function parseDurationOptions(treatment: Treatment): DurationOption[] {
  const durations = treatment.duration.split(" / ").map((item) => item.trim());
  const prices = treatment.price.split(" / ").map((item) => {
...
export const treatments: Treatment[] = [
  // ===== Promotion — Recovery Packages (4 packages) =====
  {
    id: 20,
    ...
    price: "฿1,200",
    priceValue: 1200,
    description: "Warm herbal compress massage for the neck and shoulders, finished for instant relief and relaxation.",
    highlights: [
      "Warm Herbal Compress",
      "Neck & Shoulder Relief",
      "Instant Relaxation",
    ],
    targetGuest: "Everyone / quick relief / neck & shoulder tension",
  ...
  {
    id: 21,
    name: "Double Recovery (Starter)",
    category: "Promotion",
    duration: "60 min",
    price: "฿2,100",
    priceValue: 2100,
    description: "Warm herbal compress massage for the neck and shoulders, finished for instant relief and relaxation — shared by two guests side by side.",
    highlights: [
      "Warm Herbal Compress",
      "Neck & Shoulder Relief",
      "For 2 People",
    ...
    targetGuest: "Couples & friends / quick relief together",
    bestBookingTime: "Anytime",
    notes: "Promotion",
    isPromotion: true,
    isCouple: true,
  ...
  },
  {
    ...
    price: "฿1,700",
    priceValue: 1700,
    description: "Warm herbal compress massage for the neck, shoulders, and back, finished with organic oil for deep relaxation.",
    highlights: [
      "Warm Herbal Compress",
      "Neck, Shoulders & Back",
      "Organic Oil Finish",
    ...
    targetGuest: "Everyone / deep relaxation / full upper-body relief",
    bestBookingTime: "Anytime",
    notes: "Promotion",
    isPromotion: true,
    priceNote: "per person",
  ...
  {
    id: 23,
    name: "Double Recovery (Classic)",
    category: "Promotion",
    duration: "90 min",
    price: "฿3,000",
    priceValue: 3000,
    description: "Warm herbal compress massage for the neck, shoulders, and back, finished with organic oil for deep relaxation — shared by two guests side by side.",
    highlights: [
      "Warm Herbal Compress",
      "Neck, Shoulders & Back",
      "For 2 People",
    ...
    targetGuest: "Couples & friends / deep relaxation together",
    bestBookingTime: "Anytime",
    notes: "Promotion",
    isPromotion: true,
    isCouple: true,
...
export const spaTreatments: Treatment[] = treatments.map((item) => ({
  ...item,
  image: spaAsset(item.image),
}));

export const spaAddOns: AddOn[] = addOns.map((item) => ({
  ...item,
  image: spaAsset(item.image),
}));

export function getSpaTreatment(id: number): Treatment | undefined {
  return spaTreatments.find((item) => item.id === id);
}
