...
export default function WeddingInquiryForm({ compact = false }: { compact?: boolean }) {
  ...
  const labelCls = compact
    ? "min-w-0"
    : "sm:w-40 sm:text-right flex-shrink-0";
  ...
  return (
    <section
      ...
      className={
        compact
          ? "scroll-mt-4"
          : "py-20 md:py-28 bg-[--color-surface] scroll-mt-24"
      }
    >
          ...
          <div
            className={
              compact
                ...
                : "relative bg-white p-8 md:p-12 border border-[#8B7355]/30"
            }
          >
            {!compact && (
              <>
            ...
            <div className={row}>
              ...
              <div className={compact ? "min-w-0 w-full" : "flex-1"}>
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  />
                  <span className="shrink-0 text-[--color-text-primary] font-medium w-12 text-right">
            ...
            <div className={rowTop}>
              <label className={compact ? labelCls : `${labelCls} pt-3`}>
